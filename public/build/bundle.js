    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div10 = element("div");
    			p16 = element("p");
    			p16.textContent = "Manga Reader";
    			t43 = space();
    			p17 = element("p");
    			p17.textContent = "Simple and Fast Manga Reader";
    			...
    			attr_dev(p16, "class", "m-0 font-weight-medium text-dark-lm text-light-dm text-reset");
    			add_location(p16, file, 79, 14, 4399);
    			attr_dev(p17, "class", "font-size-12 mt-0 mb-0");
    			add_location(p17, file, 80, 14, 4502);
    			attr_dev(div10, "class", "p-20 w-full m-auto");
    			add_location(div10, file, 78, 12, 4352);
    			attr_dev(div11, "class", "flex-grow-1 overflow-y-hidden d-flex align-items-center position-relative h-120");
    			add_location(div11, file, 77, 10, 4246);
    			attr_dev(a5, "href", "manga-reader/public");
    			attr_dev(a5, "class", "card w-250 mw-full m-0 p-0 d-flex mr-10 mb-10 svelte-1ggk6ul");
    			attr_dev(a5, "target", "_blank");
    			attr_dev(a5, "rel", "noopener");
    			add_location(a5, file, 76, 8, 4120);
    			attr_dev(div12, "class", "row");
    			add_location(div12, file, 30, 6, 1547);
    			attr_dev(div13, "class", "content");
    			add_location(div13, file, 21, 4, 640);
    			attr_dev(div14, "class", "content-wrapper");
    			add_location(div14, file, 20, 2, 606);
    			attr_dev(div15, "class", "page-wrapper");
    			add_location(div15, file, 19, 0, 577);
    		},
