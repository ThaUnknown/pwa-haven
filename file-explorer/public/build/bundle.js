...
var app = (function () {
    ...
    /* shared\InstallPrompt.svelte generated by Svelte v3.49.0 */
    ...
    /* file-explorer\src\Breadcrumbs.svelte generated by Svelte v3.49.0 */
    ...
    class Breadcrumbs extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*crumbs*/ ctx[0] === undefined && !('crumbs' in props)) {
    			console.warn("<Breadcrumbs> was created without expected prop 'crumbs'");
    		}

    		if (/*currentHandle*/ ctx[1] === undefined && !('currentHandle' in props)) {
    ...
    /* file-explorer\src\App.svelte generated by Svelte v3.49.0 */
