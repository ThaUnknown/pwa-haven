...
self.addEventListener('fetch', event => {
  ...
  if (!url.includes(self.registration.scope + 'player/')) return null
  if (url.includes(self.registration.scope + 'player/keepalive/')) return event.respondWith(new Response())
